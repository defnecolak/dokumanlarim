const PLANS = {
  ...
  team: {
    ...
    retentionDays: 365,
    features: ['Takım kullanımı', 'Ekip daveti (10 kullanıcı)', 'Gelişmiş raporlar', 'Aktivite zaman çizelgesi'],
  },
  pro: {
    code: 'pro',
    label: 'Pro',
    ...
    retentionDays: 3650,
    features: ['Çoklu ekip', 'Ekip daveti (30 kullanıcı)', 'Öncelikli destek', 'Webhook entegrasyonları', 'Çoklu dil (TR/EN)'],
  },
};
